...
import org.cliophate.tome.playback.service.TomeDataSourceFactory
...
object MediaModule {
  ...
  fun provideExoPlayer(
    @ApplicationContext context: Context,
    sharedPreferences: TomeSharedPreferences,
    mediaCache: Cache,
    requestHeadersProvider: RequestHeadersProvider,
    mediaProvider: TomeMediaProvider,
  ): ExoPlayer {
    ...
    val player =
      ExoPlayer
        ...
        .setMediaSourceFactory(
          TomeMediaSourceFactory(
            mediaSourceFactory =
              DefaultMediaSourceFactory(
                TomeDataSourceFactory(
                  baseContext = context,
