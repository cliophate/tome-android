...
import org.cliophate.tome.ui.theme.LightBackground
import org.cliophate.tome.ui.theme.MediumBackground
...
import org.cliophate.tome.widget.state.PlayerStateWidget.Companion.bookIdKey
      ...
      GlanceTheme(
        ...
        val chapterTitle =
          state[chapterTitle]
            ...
            ?: when (bookId) {
              "" -> context.getString(org.cliophate.tome.R.string.widget_placeholder_text)
              else -> ""
            }
...
private suspend fun safelyRun(
  ...
  context: Context,
  action: (org.cliophate.tome.widget.WidgetPlaybackController) -> Unit,
) {
  try {
