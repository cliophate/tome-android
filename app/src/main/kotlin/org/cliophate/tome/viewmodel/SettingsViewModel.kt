...
import org.cliophate.tome.common.ColorScheme
import org.cliophate.tome.common.LibraryOrderingConfiguration
import org.cliophate.tome.common.NetworkTypeAutoCache
import org.cliophate.tome.common.PlaybackVolumeBoost
...
import org.cliophate.tome.lib.domain.connection.LocalUrl
import org.cliophate.tome.lib.domain.connection.LocalUrl.Companion.clean
import org.cliophate.tome.lib.domain.connection.ServerRequestHeader
import org.cliophate.tome.lib.domain.connection.ServerRequestHeader.Companion.clean
...
class SettingsViewModel
  ...
  constructor(
    ...
    private val _serverConnected = MutableLiveData(false)
    ...
    fun logout() {
      _serverConnected.postValue(false)
      ...
      viewModelScope.launch {
        when (val response = mediaChannel.fetchConnectionInfo()) {
          ...
          is OperationResult.Success -> {
            ...
            _serverConnected.postValue(true)
