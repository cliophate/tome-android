package org.cliophate.tome.channel.audiobookshelf.common
...
abstract class AudiobookshelfChannel(
  ...
  protected val preferences: TomeSharedPreferences,
  ...
  protected fun getClientName() = "Tome App ${BuildConfig.VERSION_NAME}"
}
